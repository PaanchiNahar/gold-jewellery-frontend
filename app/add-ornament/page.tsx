...
const formSchema = z.object({
  ornamentId: z.string().min(2, {
    message: "Ornament ID must be at least 2 characters.",
  }),
  type: z.string({
...
export default function AddOrnamentPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      if (response.success) {
        toast({
          title: "Ornament added successfully",
          description: `Ornament ID: ${values.ornamentId} has been added to inventory`,
        })

        // Generate QR code with ornament data
        setQrCode(
          JSON.stringify({
            ornamentId: values.ornamentId,
            type: values.type,
      ...
      toast({
        title: "Error adding ornament",
        description: "There was a problem adding the ornament. Please try again.",
        variant: "destructive",
      })
    }
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold tracking-tight mb-6">Add New Ornament</h1>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter the details of the new ornament to add to inventory</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Ornament ID</FormLabel>
                          <FormControl>
                            <Input placeholder="R123" {...field} />
                          </FormControl>
                          <FormDescription>Enter a unique ID for this ornament</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Enter the unique code for the merchant</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The generated QR code for the ornament</CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center justify-center min-h-[300px]">
                {qrCode ? (
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Scan this QR code to access ornament details</p>
                  </div>
                ) : (
        ...
        <TabsContent value="bulk">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload multiple ornaments at once using a CSV file</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="border-2 border-dashed rounded-md p-6 text-center">
                  <div className="mx-auto flex flex-col items-center justify-center gap-1">
                    <div className="text-muted-foreground">
                      ...
                      <Input type="file" className="max-w-sm mx-auto" accept=".csv" />
                    </div>
                  </div>
                </div>
                <div>
